...
public class MainGraphSequencia extends ApplicationFrame {
	 ...
	 */
	public MainGraphSequencia(final String title) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
...
//		s.executeQuery("select * from sorteios_grouped_quadrante order by CONCURSO LIMIT 150 ");
		...
		s.executeQuery("select * from sorteios_grouped_seq where codigo <= 50 order by codigo");
...
//		plot.setAxisOffset(new Spacer(arg0, arg1, arg2, arg3, arg4));
	...
	public static void main(final String[] args) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
		...
		final MainGraphSequencia demo = new MainGraphSequencia("Line Chart Demo 6");
		demo.pack();
