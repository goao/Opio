...
public class MainGraphQtdRandom extends ApplicationFrame {
	 ...
	 */
	public MainGraphQtdRandom(final String title) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
...
//		s.executeQuery("select * from sorteios_grouped_quadrante order by CONCURSO LIMIT 150 ");
		...
		s.executeQuery("select count(1) as qtd,numero from  random2_bb group by 2 order by 1");
...
//		plot.setAxisOffset(new Spacer(arg0, arg1, arg2, arg3, arg4));
	...
	public static void main(final String[] args) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
		...
		final MainGraphQtdRandom demo = new MainGraphQtdRandom("Line Chart Demo 6");
		demo.pack();
