...
public class MainGraphQuadrante extends ApplicationFrame {
	 ...
	 */
	public MainGraphQuadrante(final String title) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
...
//		s.executeQuery("select * from sorteios_grouped_quadrante order by CONCURSO LIMIT 150 ");
		...
		s.executeQuery("select * from sorteios_grouped_quadrante  where concurso <= 50 order by concurso, quadrante");
		...
		while (rs.next()) {    	
			int concurso = rs.getInt("concurso");
			int quadrante = rs.getInt("quadrante");
...
//		plot.setAxisOffset(new Spacer(arg0, arg1, arg2, arg3, arg4));
	...
	public static void main(final String[] args) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
		...
		final MainGraphQuadrante demo = new MainGraphQuadrante("Line Chart Demo 6");
		demo.pack();
