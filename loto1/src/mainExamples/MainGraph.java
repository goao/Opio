...
public class MainGraph extends ApplicationFrame {
	 ...
	 */
	public MainGraph(final String title) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
...
//		s.executeQuery("select * from sorteios_grouped_quadrante order by CONCURSO LIMIT 150 ");
		...
		s.executeQuery("select * from sorteios_grouped  where concurso <= 20000 order by concurso, dezena");
...
//		plot.setAxisOffset(new Spacer(arg0, arg1, arg2, arg3, arg4));
	...
	public static void main(final String[] args) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
		...
		final MainGraph demo = new MainGraph("Line Chart Demo 6");
		demo.pack();
